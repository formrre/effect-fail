...
To produce graded bind, we append the 2 lists of effects andcombine them.
...
We would excpect this API to propagate pattern matching failure. To run an effectfail we either want to extract the underlying result or propagate the failure of underlying Pure result.
