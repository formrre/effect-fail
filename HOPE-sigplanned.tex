...
\begin{abstract}
Algebraic effects are one possible approach to tackle modularity issues arising in applications where normally we would use monad transformers.
One such application area is in (formalised) programming language
semantics. This setting motivates an extension of algebraic effects to
include the notion of non-recoverable failure.
...
We show how to use the MaybeT transformer to achieve this. We also explore the graded structure of effect monads.
\end{abstract}
