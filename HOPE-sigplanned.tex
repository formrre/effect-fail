...
The importance of this is that we can provide an interface,
which chains different operations abstractly, postponing the concrete implementation until the full specification should be provided.
