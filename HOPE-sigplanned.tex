...
equations. We note that by theorems 3.1 and 3.2 \cite{ncatlab} this result should follow in homotopy type theory.
...
inductive types). Informally left Kan extension, Lan(X), of a datatype X should give us an endofunctor, which just accumulates functions applied to it
